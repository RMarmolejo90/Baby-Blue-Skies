  ...
  return (
    <div className='p-4 py-20 text-center flex items-center flex-col justify-center text-lg bg-secondary-light lg:px-20'>
     <Fade duration={2000}>
        ...
        <a className='p-2 px-10 m-4 leading-6 tracking-wider text-sm bg-button-color font-semibold border rounded-md' href="https://docs.google.com/forms/d/e/1FAIpQLScvZkBlv69f74k6q7XJ9szgq_JoZR9Nhug3dsN67I06iQ5Neg/viewform">
            Start A New Trip
        </a>
      </Fade>
    </div>
