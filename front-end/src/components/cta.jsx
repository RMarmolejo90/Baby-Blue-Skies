...
export default function Cta() {
  return (
    <div className='p-8 text-center flex items-center flex-col justify-center'>
        ...
        <a className='p-2 m-4 text-sm bg-green-400 font-semibold border rounded-xl' href="https://docs.google.com/forms/d/e/1FAIpQLScvZkBlv69f74k6q7XJ9szgq_JoZR9Nhug3dsN67I06iQ5Neg/viewform">
            Start A New Trip
        </a>
    </div>
  )
