            ...
            <div className='shadow-xl mb-28 text-center p-6 pb-10 flex flex-col flex-wrap items-center justify-center mt-10 rounded-xl border backdrop-brightness-150 backdrop-blur-sm backdrop-saturate-[.35]'> 
                <Fade delay={200} duration={3000}>
                    ...
                    <Zoom delay={500} duration={2000}>
                        <a className='p-2 px-10 m-4 leading-6 tracking-wider text-sm bg-button-color text-black-shade font-semibold border rounded-md hover:border-dark-shade hover:shadow-xl' href="https://docs.google.com/forms/d/e/1FAIpQLScvZkBlv69f74k6q7XJ9szgq_JoZR9Nhug3dsN67I06iQ5Neg/viewform">
